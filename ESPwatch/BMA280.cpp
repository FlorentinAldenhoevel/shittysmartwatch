...
void BMA280::transfer(uint8_t address, uint8_t *outdata, uint8_t outcount, uint8_t *indata, uint8_t incount)
{
  /*
  Serial.print("transfer: ");
  Serial.print(address, HEX);
  Serial.print("  ");
  Serial.print(outdata[0], HEX);
  Serial.print("  ");
  Serial.print(outcount,HEX);
  Serial.println();
  */
  Wire.beginTransmission(address);
  Wire.write(outdata, outcount);
  ...
  { 
    /*
    Serial.print(incount,HEX);
    Serial.print("  ");
    Serial.println();
    */
    Wire.requestFrom(address, incount);
    while(Wire.available()<incount)
    {}
